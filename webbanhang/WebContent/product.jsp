    ...
    <div class="contain">
        ...
        <div class="main1">
            <div class="main-about1">
                <div class="about-text">COOKING RECIPE</div>
                <div class="all-list">
                    <a href="/list1.jsp">
                        <div class="list10">
                            <div class="list1">
                                <div class="list1-img"></div>
                                <div class="list-content">
                                    <div class="Name">Hearty Pumpkin Soup</div>
                                    <div class="Date">by Penci Design/October 20, 2022</div>
                                    <div class="IFM">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the…</div>
                    ...
                    <div class="list10">
                        <div class="list1">
                            <div class="list2-img"></div>
                            <div class="list-content">
                                <div class="Name">Salmon Skewers with Zucchini</div>
                                <div class="Date">by Penci Design/October 24, 2022</div>
                                <div class="IFM">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the…</div>
                                <div class="More">READ THE ARTICLE</div>
                            </div>
                        </div>
                ...
                <a href="list3.jsp">
                    <div class="list10">
                        <div class="list1">
                            <div class="list3-img"></div>
                            <div class="list-content">
                                <div class="Name">Crepes with Fresh Fruit</div>
                                <div class="Date">by Penci Design/October 25, 2022</div>
                                <div class="IFM">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the…</div>
                                <div class="More">READ THE ARTICLE</div>
                            </div>
                        </div>
                ...
                <a href="list4.jsp">
                    <div class="list10">
                        <div class="list1">
                            <div class="list4-img"></div>
                            <div class="list-content">
                                <div class="Name">Breakfast Zucchini Fritters</div>
                                <div class="Date">by Penci Design/October 18, 2022</div>
                                <div class="IFM">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the…</div>
                                <div class="More">READ THE ARTICLE</div>
                            </div>
                        </div>
                ...
                <a href="/list5.jsp">
                    <div class="list10">
                        <div class="list1">
                            <div class="list5-img"></div>
                            <div class="list-content">
                                <div class="Name">Bread with Beetroot Hummus</div>
                                <div class="Date">by Penci Design/October 27, 2022</div>
                                <div class="IFM">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the…</div>
                                <div class="More">READ THE ARTICLE</div>
                            </div>
                        </div>
            ...
            <div class="main-about2">
                ...
                <div class="newletter">
                    ...
                    <div id="give">
                        <<div id="from">
                            <form action="commenttc4" method="post">
				                <h2>Email</h2>
