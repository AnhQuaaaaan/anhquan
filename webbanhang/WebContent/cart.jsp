			...
			<div class="table-wrapper">
							...
							<tr>
								...
								<td class="tg">
									 <div class="More-1">
                                            ...
                                            <div class="More-3"><a href="giamcart?product_name=${o.name }"><i class="fa-solid fa-minus"style="font-size: 25px;"></i></a></div>
                                        </div>
								</td>
								<td>
								...
								<td><font color="red" size="12"> <a
										...
										class="btn btn-outline-danger"> Hủy Đơn</a></font></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
				...
				<div class="footer">
					<div class="About">
						...
						<div class="About-text1">NTK Blog là chuyên trang chia sẻ
							các kiến thức, trải nghiệm về cuộc sống của tác giả nhằm đem đến
							cho người xem những kiến thức bổ ích và điều thú vị xoay quanh
							cảm nhận và góc nhìn của tác giả.</div>
					</div>
						...
						<div class="list">
							<ul>
								...
								<li><a href="about.jsp"><i class="fa-solid fa-user"></i>
										About</a></li>
								<li><a href="cakect"><i
										class="fa-solid fa-cake-candles"></i> Sản Phẩm</a></li>
