        ...
        <div class="main1">
            <div class="main-about1">
                ...
                <div class="login__container">
                    ...
                    <h5>ID</h5>
                      <input type="text" class="input-login-userid" name="id" value="${detail.id}" readonly />
                      <h5>NAME</h5>
                      <input type="text" class="input-login-name" name="name" value="${detail.name}" />
                      <h5>PRICE</h5>
                      <input type="text" class="input-login-price"name="price" value="${detail.price}" />
                      <h5>IMAGE</h5>
                      <input type="text" class="input-login-img"name="img" value="${detail.img}" />
                      <button type="submit" class="login__signInButton">FIX</button>
                    </form>
                    <a href="fixct" class="login__registerButton"
                      >CANEL</a
                    >
                  </div>
                </div>
